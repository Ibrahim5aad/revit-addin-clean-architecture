...
namespace RevitAddin.Core.DI
{
  ...
  public class IoC : IDisposable
  {
    ...
    /// <summary>
    /// Register a servic of type TService providing
    /// an already initialized instance of the service
    /// type.
    /// </summary>
    /// <typeparam name="TService"> Type of service. </typeparam>
    /// <param name="implementation"> The object that provides an implementation of the service. </param>
    /// <returns></returns>
    public IoC RegisterSingleton<TService>(TService implementation) where TService : class
    {
